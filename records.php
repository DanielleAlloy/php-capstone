        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="list.php">List Cameras<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="add.php">Add Camera</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="search.php">Search Cameras</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="delete.php">Delete Camera</a>
                </li>
            </ul>
...
<div class="container">
    ...
    <table class="table table-dark table-hover table-responsive">
        ...
        for ($j = 0 ; $j < $rows ; ++$j)
        {
            ...
            echo"<td><form action='records.php' method='post'>
